...
fn CInt regcomp(
    ...
    CInt flags);
```
Compiles a regular expression into a `Regex_t` variable.
...
fn CInt regexec(
    ...
    CInt eflags);
```
Matches a compiled regular expression with a string, and populates the array of potential match groups.
...
fn CULong regerror(
    ...
    CULong errbuf_size);
```
Stores a string version of the PCRE2 error code in the provided buffer.
...
This library is released under the MIT license. PCRE2 is provided under the BSD license.